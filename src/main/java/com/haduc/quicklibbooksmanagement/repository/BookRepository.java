...
public interface BookRepository extends JpaRepository<Book, Long>, PagingAndSortingRepository<Book, Long> {
    ...
    @Query("SELECT b.id,b.title,b.description,b.quantity,b.cover_image_url,b.publisher,b.publish_year,b.language,b.page_number,b.created_at,b.updated_at,c.id, c.name, c.parent_category_id, l.id, l.name, l.location, lb.code, lb.status FROM Book b JOIN Category c ON b.category.id = c.id JOIN LibraryBook lb ON b.id = lb.book.id JOIN Library l ON lb.book.id = l.id")
